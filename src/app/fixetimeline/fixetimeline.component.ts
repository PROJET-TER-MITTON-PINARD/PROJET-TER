...
@Component({
  selector: 'app-fixetimeline',
  templateUrl: './fixetimeline.component.html',
  styleUrls: ['./fixetimeline.component.scss']
})
export class FixetimelineComponent implements OnInit {

  public title = 'Fixe timeline';
  ...
  public ngOnInit(): void {
    var timeline = (<SVGSVGElement><unknown>document.getElementById("fixetimeline"));
    if (timeline != null) {
  ...
  private buildSvg() {
    this.svg = d3.select('#fixetimeline')
      .append('g')
      .attr('transform', 'translate(' + this.margin.left + ',' + this.margin.top + ')');
      d3.select("#fixetimeline").on("mousemove", (event: any, d: any) => this.showInfo(event, d))
  ...
  private addXandYAxis() {
    ...
    this.y.domain(d3Array.extent([30,0]));
